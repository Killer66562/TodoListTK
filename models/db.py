...
from sqlalchemy import ForeignKey, Integer, String, DateTime, Table, Column, Boolean
...
class Activity(Base):
    ...
    done: Mapped[bool] = mapped_column(Boolean, unique=False, index=False, nullable=False, default=False)
